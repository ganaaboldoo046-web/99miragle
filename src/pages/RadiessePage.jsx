...
const RadiessePage = ({ onBack }) => {

  const recommendations = [
    "Аюулгүй байдал болон гаж нөлөөнд санаа зовж буй хүмүүст",
    "Арьсны уян хатан байдал нийтдээ алдагдаж эхэлсэн хүмүүст",
    "Филлэр үйлчилгээнд санаа зовдог хүмүүст",
    "Төрөлхийн мэт арьсны чанарыг сайжруулж, үр дүнг удаан хугацаанд хадгалахыг хүссэн хүмүүст"
  ];
  ...
  const precautions = [
    ...
    "Хэвийн бус шинж тэмдэг (улайлт, удаан өвдөх г.м) удаан үргэлжилбэл эмнэлэгт хандан эмчтэй зөвлөлдөнө үү."
  ];
  ...
  return (
    <div className="bg-slate-50 flex flex-col font-sans relative w-full max-w-[430px] mx-auto shadow-2xl overflow-x-hidden text-slate-800 min-h-screen">
      ...
      <section className="relative h-[90vh] w-full bg-slate-200 flex flex-col justify-end overflow-hidden group">
        <img
          src="/페이지 이미지/tci00400001153.gif"
          alt="Radiesse Treatment"
        ...
        <div className="relative z-10 px-7 pb-16 animate-fade-in-up delay-100">
          ...
          <h2 className="text-[34px] font-black leading-[1.08] text-slate-800 tracking-tight mb-6 drop-shadow-md">
            Арьсанд уян хатан,<br/>залуужуулах<br/>шинэлэг<br/>үйлчилгээ
          </h2>
          <div className="h-[1px] w-16 bg-slate-400 mb-6"></div>
          <p className="text-[14px] text-slate-600 font-medium leading-relaxed">
            Коллагеныг идэвхжүүлж, арьсыг илүү өнгөлөг болгоно уу.
          </p>
      ...
      <section className="w-full bg-slate-50 flex flex-col">
        ...
        <div className="grid grid-cols-2 min-h-[260px]">
          <div className="bg-slate-200 text-slate-900 p-6 flex flex-col justify-center animate-fade-in-up delay-200 relative overflow-hidden">
            ...
            <h3 className="text-[17px] font-black leading-snug mb-3 relative z-10">Төрөлхийн мэт<br/>дүүргэлт</h3>
            <p className="text-[11px] text-slate-600 font-medium leading-relaxed relative z-10">
              Кальцийн гидроксиапатит (CaHA) нь арьсанд эзэлхүүнийг найдвартай нөхнө.
            </p>
          </div>
          <div className="bg-slate-300 relative overflow-hidden group">
            <img src="/페이지 이미지/tci00700000011.jpg" alt="Radiesse Volume" className="absolute inset-0 w-full h-full object-cover transform duration-[3000ms] group-hover:scale-105" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 min-h-[260px]">
          <div className="bg-slate-300 relative overflow-hidden group">
            <img src="/페이지 이미지/tica1010016694.jpg" alt="Collagen Info" className="absolute inset-0 w-full h-full object-cover transform duration-[3000ms] group-hover:scale-105" />
          </div>
          <div className="bg-white text-slate-900 p-6 flex flex-col justify-center animate-fade-in-up delay-300 relative">
            ...
            <p className="text-[11px] text-slate-500 font-medium leading-relaxed">
              Арьсны уян хатан байдал болон гадаргууг урт хугацаанд сайжруулна.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-slate-50 py-12 px-5">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-slate-200/60 animate-scale-in delay-300 relative group flex flex-col mb-8">
          ...
          <div className="h-48 relative overflow-hidden">
             <img src="/페이지 이미지/td02220001654.jpg" alt="CaHA Principle Focus" className="w-full h-full object-cover origin-center transform transition-transform duration-[4000ms] group-hover:scale-110" />
             <div className="absolute inset-0 bg-gradient-to-t from-slate-900/40 to-transparent"></div>
             <div className="absolute bottom-4 left-5 flex items-center gap-2">
                 <Layers size={18} className="text-white" />
                 <span className="text-[13px] font-bold text-white tracking-wider uppercase drop-shadow-md">Calcium Hydroxylapatite (CaHA)</span>
             </div>
          </div>
          {/* Content Area */}
          <div className="p-6 bg-gradient-to-b from-slate-50 to-white relative">
            ...
            <p className="text-[13px] font-medium leading-[1.8] text-slate-600 mb-4">
              Радиесс нь АНУ-ын FDA-аас зөвшөөрөгдсөн филлэр бөгөөд гол орц болох кальцийн гидроксиапатит (CaHA) бичил хэсгүүдийн тусламжтайгаар тариулсан хэсэгт тэр даруй эзэлхүүнийг дүүргэнэ.
            </p>
            <p className="text-[13px] font-medium leading-[1.8] text-slate-600">
              Үүнээс хойш арьсан дахь коллагены нийлэгжилтийг аяндаа идэвхжүүлснээр арьсны уян хатан чанар, бүтцийг <strong className="text-slate-900 border-b border-slate-400 pb-0.5">урт хугацаанд</strong> сайжруулна. Голчлон нүүрний хэлбэрийг засах, үрчлээ арилгах болон гарын шууны эзэлхүүнийг нэмэхэд ашиглагддаг.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="space-y-4 animate-fade-in-up delay-300">
          ...
          <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
            ...
            <div className="flex flex-col">
               <p className="text-[14px] font-bold text-slate-700 mb-1">Тохируулга массаж</p>
               <p className="text-[12px] text-slate-500 font-medium">(Шаардлагатай бол) Үйлчилгээ хийсэн хэсэгт зөөлөн массаж хийж филлэрийг жигд тараана.</p>
            </div>
          </div>
          <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
        ...
        <div className="space-y-4 animate-fade-in-up delay-300">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
             <h4 className="font-bold text-[14px] text-slate-800 mb-3 flex gap-2 items-start">
               ...
               Радиесс үйлчилгээ нь аюулгүй юу?
             </h4>
             <p className="text-[12px] text-slate-600 leading-relaxed pl-6 mb-2">
               Энэ нь АНУ-ын FDA болон Европын CE гэрчилгээтэй, аюулгүй байдал нь батлагдсан филлэр юм. Гол орц болох CaHA нь хүний ясны бүтэцтэй төстэй бөгөөд биед бүрэн уусаж, коллагенаар солигддог. 
             </p>
             <p className="text-[12px] text-slate-600 leading-relaxed pl-6">
               Энгийн гиалуроны хүчлийн филлэртэй харьцуулахад эзэлхүүн өгөхийн сацуу коллагены нийлэгжилтийг давхар дэмждэг давуу талтай. Мэргэшсэн эмчид хандах нь чухал.
             </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
             <h4 className="font-bold text-[14px] text-slate-800 mb-3 flex gap-2 items-start">
               <HelpCircle size={18} className="text-slate-400 shrink-0 mt-0.5" />
               Үйлчилгээний дараа шууд үр дүн гарах уу?
             </h4>
             <p className="text-[12px] text-slate-600 leading-relaxed pl-6 mb-2">
               Тийм ээ, үйлчилгээний дараа тэр даруй нүхжилт дүүрч, арьс товойх үр дүнг физик таталцаар харах боломжтой.
             </p>
             <p className="text-[12px] text-slate-600 leading-relaxed pl-6">
               Үүнээс хойш 1-2 сарын дараа кальцийн ширхгүүд фибробластуудыг идэвхжүүлснээр коллаген болон эластины нийлэгжилт явагдаж, арьсны уян хатан байдал алгуурхан сайжирна. Эцсийн үр дүн 2-3 сарын дараа илүү тод харагдах ба дунджаар 12-18 сар үргэлжилнэ.
             </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
             ...
             <p className="text-[12px] text-slate-600 leading-relaxed pl-6">
               Маш аюулгүй орцоос бүрддэг боловч тарилгын онцлогоос шалтгаалан түр хавдах, улайх, хөхрөх, тариулсан хэсэгт бага зэрэг өвдөх зэрэг хөнгөн шинж тэмдэг илэрч болно. Энэ нь хэд хоногийн дотор аяндаа алга болдог бөгөөд санаа зовох зүйлгүй. Маш ховор тохиолдолд буруу давхаргад хийснээс шалтгаалсан ургацаг үүсэж болох тул туршлагатай эмчээр хийлгэх шаардлагатай.
             </p>
          </div>
        </div>
